            ...
            <ul className="mb-6 flex flex-col gap-2">
              ...
              <li>
                <NavLink
                  to="/medication"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/medication" && // Changed from includes() to exact match
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M4.929 19.071a6.5 6.5 0 0 1 0-9.192l5.657-5.657a6.5 6.5 0 1 1 9.192 9.192l-5.657 5.657a6.5 6.5 0 0 1-9.192 0zM6.343 6.343a4.5 4.5 0 0 0 0 6.364m5.657-1.414 6.364-6.364"
                      stroke="currentColor"
                      strokeWidth="2"
                      strokeLinecap="round"
              ...
              <li>
                <NavLink
                  to="/medicationhistory"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/medicationhistory" && // Changed from includes() to exact match
                    "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                  ...
                  >
                    <path
                      d="M7 3H17C18.1 3 19 3.9 19 5V21C19 22.1 18.1 23 17 23H7C5.9 23 5 22.1 5 21V5C5 3.9 5.9 3 7 3ZM7 5V21H17V5H7ZM9 9H11V13H15V15H11V19H9V15H5V13H9V9Z"
                      fill="currentColor"
                    />
                  </svg>
                  Medications History
              ...
              <li>
                ...
                >
                  ...
                  >
                    <path
                      d="M12 2C10.34 2 9 3.34 9 5V6C6.24 6 4 8.24 4 11V17L2 19V20H22V19L20 17V11C20 8.24 17.76 6 15 6V5C15 3.34 13.66 2 12 2ZM12 22C13.1 22 14 21.1 14 20H10C10 21.1 10.9 22 12 22Z"
                      fill="currentColor"
                    />
                  </svg>
                  Reminders
              ...
              <SidebarLinkGroup
                activeCondition={
                  pathname === "/" || pathname.includes("setting")
                }
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <button className="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white">
                              <svg
                                className="fill-current"
                                width="22"
                                height="22"
